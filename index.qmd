...
Throughout my undergraduate career I was trying to figure out the different things that I was interested in, which turned out to be understanding how the world worked through science and math. I discovered through taking chemistry and math classes that I liked to understand the theoretical reasons of why things happen the way that they do in our world. I also discovered through research that combined both chemistry and math that a lot of chemistry theory uses very complex mathematical ideas. I became very excited in applying theoretical mathematical ideas to explain the phenomena that we see around us and the idea of working to understand different scientific ideas from a mathematical perspective. I would like my future work to explore this area of research and delve into collaborations with scientists in different areas to explore how they are using mathematical concepts in their fields and working to create new methods to understand ideas that they are exploring. 

I would like to build my career around collaboration and discovery, which I think are things that the biostatistics community really values as a whole. I decided to go into biostatistics because it felt like a field where the community values working together and working with other scientists to understand different ideas. In 5-10 years I will ideally be working with multiple collaborators to come up with new statistical methods and thinking about how those methods can impact our scientific understanding of different health conditions. I would like my career to be one where I feel like I am contributing to scientific understanding while also enjoying the theoretical work that I feel like I don't really get tired of doing. 
...
```{bash}
cut -d "," -f 6 students.csv > subject.txt
sort subject.txt > subject_sort.txt
uniq subject_sort.txt
```

10. Calculate the average grade of the students. Use `awk` to sum the grades and divide by the number of students.

```{bash}
tail -10 students.csv > students_tail.csv
awk -F',' '{ sum += $5 } END { avg = sum / NR; print "Average: " avg }' students_tail.csv
```
